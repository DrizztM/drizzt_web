...
import project.common.interceptor.admin.AdminContextInterceptor;
import project.common.view.admin.AdminFreeMarkerView;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "project.views.controller.admin", useDefaultFilters = false, includeFilters = { @ComponentScan.Filter(value = { Controller.class }) })
