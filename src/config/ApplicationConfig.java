...
import project.logic.component.FileComponent;
import project.logic.component.MailComponent;
 ...
 */
@Configuration
@ComponentScan(basePackages = "project", excludeFilters = { @ComponentScan.Filter(value = { Controller.class }) })
...
public class ApplicationConfig {
    ...
    public FactoryBean<SessionFactory> sessionFactory() {
        ...
        bean.setPackagesToScan(new String[] { "project.entities" });
