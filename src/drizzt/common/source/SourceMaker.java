...
import drizzt.common.source.entity.EntityColumn;
import drizzt.common.source.entity.EntityCondition;
import drizzt.common.source.entity.MyColumn;
import drizzt.common.tools.FreeMarkerUtils;
import drizzt.common.tools.MyClassUtils;
...
public class SourceMaker {
    ...
    public static void main(String[] args) {
        ...
        String basePackage = "project";
        // sourceMaker.make(basePackage, "aaa", overwrite);
        try {
            Class<?> c = Class.forName("project.entities.cms.CmsContent");
