 ...
 */
@Entity
@Table(name = "sys_user", uniqueConstraints = { @UniqueConstraint(columnNames = "auth_token"),
...
public class SysUser implements java.io.Serializable {
    ...
    public SysUser(String name, String password, String nickName, boolean emailChecked, boolean superuserAccess,
    ...
    public SysUser(String name, String password, String nickName, Integer deptId, String roles, String email,
